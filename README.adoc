...
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-network-config/index.deploy.html
...
* VLANs for GSE and SMV traffic
* MAC address filtering for SMV traffic
* Configuration of uplink/downlink ports.
